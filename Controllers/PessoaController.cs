...
namespace src.Controllers
{
    ...
    {   
        ...
        [HttpGet("{uf}")]
        public async Task<IActionResult> BuscarPorUF(UF uf)
        {
            return Ok(_pessoaService.BuscarPorUF(uf));
        }
        ...
        [HttpPost]
        public async Task<IActionResult> AdicionarPessoa([FromFormAttribute] Pessoa  adicionarPessoa) => Ok(_pessoaService.AdicionarPessoa(adicionarPessoa));
